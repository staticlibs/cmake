...
if ( NOT DEFINED STATICLIB_ROOT_SOURCE_DIR )
    ...
    set ( CMAKE_LIBRARY_OUTPUT_DIRECTORY_DEBUG ${STATICLIB_ROOT_BINARY_DIR}/lib CACHE INTERNAL "" )
    set ( CMAKE_LIBRARY_OUTPUT_DIRECTORY_RELEASE ${STATICLIB_ROOT_BINARY_DIR}/lib CACHE INTERNAL "" )    
    set ( CMAKE_ARCHIVE_OUTPUT_DIRECTORY ${STATICLIB_ROOT_BINARY_DIR}/lib CACHE INTERNAL "" )
    set ( CMAKE_ARCHIVE_OUTPUT_DIRECTORY_DEBUG ${STATICLIB_ROOT_BINARY_DIR}/lib CACHE INTERNAL "" )
    set ( CMAKE_ARCHIVE_OUTPUT_DIRECTORY_RELEASE ${STATICLIB_ROOT_BINARY_DIR}/lib CACHE INTERNAL "" )
endif ( )
