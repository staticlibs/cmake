...
macro ( staticlib_enable_testing _includes_var_name _libs_var_name _opts_var_name )
    if ( "${STATICLIB_ROOT_SOURCE_DIR}" STREQUAL "${PROJECT_SOURCE_DIR}" )
        ...
        foreach ( _testsrc ${${PROJECT_NAME}_TEST_SRC} )
            ...
            get_target_property ( ${_testname}_CFLAGS ${_testname} COMPILE_OPTIONS )
            set_target_properties ( ${_testname} PROPERTIES COMPILE_OPTIONS ${${_testname}_CFLAGS} ${${_opts_var_name}} )
